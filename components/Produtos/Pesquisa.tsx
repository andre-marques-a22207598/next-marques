    ...
    return (
        <div className="flex justify-between items-center">
            <div className="flex items-center">
                ...
                <input type="text" value={pesquisa} onChange={(e) => pesquisar(e.target.value)} maxLength={50} placeholder="Clique para pesquisar" className="w-[400px] px-[5px] py-[5px] rounded-[4px] bg-pink-300"/>
            </div>
